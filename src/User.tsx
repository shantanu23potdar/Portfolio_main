...
const SkillInfo = [
    ...
    {
        title: "Tools",
        skills: ["Git", "Github", "VS Code", "Postman", "Figma", "PowerBI"]
    }
]
const socialLinks = [
    ...
    { link: "https://www.instagram.com/shantanu_23s/_", icon: IconBrandInstagram }, 
...
const ExperienceInfo = [
    {
        ...
        company: "Maharashtra Remote Sensing Applications Centre",
        date: " Jan 2024- June 2024 ",
        desc: " Developed expertise in Power BI to create interactive dashboards and comprehensive reports, enhancing datavisualization and decision-making processes. Gained hands-on experience with ArcGIS through active participation in the MahaBHUMI Project, contributing to the creation of a GIS-based digital basemap for integrated planning in Maharashtra State.",
        skills: ["Power BI","React JS","Node JS","Express JS","MongoDB" ,"ArcGIS" ,"MSExcel"]
    },
    {
