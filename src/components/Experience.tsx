...
// const TimelineItem = (items: any) => {
//     return items.map((item: any, index: number) => <Timeline.Item data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine" key={index} bullet={<IconBriefcaseFilled className="!text-bgColor" size={20} />} >
...
//             <div className="text-lg font-medium text-textColor flex gap-1"><div className="font-semibold text-white">Skills:</div>
//                 <div className="flex gap-1 flex-wrap">
//                     {
//                         item.skills.map((skill: any, index: number) => <div key={index}> &#x2022; {skill} </div>)
//                     }
